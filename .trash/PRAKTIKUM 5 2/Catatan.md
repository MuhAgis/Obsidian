...
# Tabel Pegawai 
![has- `MAX(gaji)` untuk menampilkan nilai maksimum atau terbesar/tertinggi dari suatu data dalam kolom yang dipilih. Gaji adalah nama kolom yang dipilih.
...
![Praktikum](PRAKTIKUM%205/Aset/2.jpg)
...
![Praktikum](PRAKTIKUM%205/Aset/3.jpg)
...
![Praktikum](PRAKTIKUM%205/Aset/4.jpg)
...
```
## Hasil
![hasil](PRAKTIKUM%205/Aset/11.jpg)
...
```
## Hasil
![hasil](PRAKTIKUM%205/Aset/12.jpg)
...
```
## Hasil
![hasil](PRAKTIKUM%205/Aset/13.jpg)
...
### Hasil
![gambar](PRAKTIKUM%205/Aset/17.jpg)
## 18
### Program
```Mysql
Select COUNT(NIP) AS JumlahPegawai,SUM(Gaji) AS totalGaji
...
- `Hasilnya`= ada 2 barisan data yang memenuhi kondisi `<= 2600000` Adapun kondisi where yang 